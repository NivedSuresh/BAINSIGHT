package org.bainsight.updates.Config.Aeron;
...
public class AeronConfig {
    ...
    /*TODO: REMOVE setProperty() call before hosting */
    static {
        System.setProperty("aeron.sample.embeddedMediaDriver", "true");
        EMBEDDED_MEDIA_DRIVER = Objects.equals(System.getProperty("aeron.sample.embeddedMediaDriver"), "true");
        LINGER_TIMEOUT_MS = 0;
    }
