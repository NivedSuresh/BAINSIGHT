...
//
//
//                /* Both Admin and Watchlist can submit refresh token as header and can
...
//                .pathMatchers("/api/bainsight/risks/order/**").hasAnyAuthority("CLIENT", "ADMIN")
//
//                .pathMatchers("/api/bainsight/risks/admin/**").hasAuthority("ADMIN")
//
//
